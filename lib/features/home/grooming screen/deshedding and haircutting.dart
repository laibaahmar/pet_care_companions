...
class desheddingandbrushingscreen extends StatefulWidget {
  const desheddingandbrushingscreen({super.key});

  @override
  State<desheddingandbrushingscreen> createState() => _desheddingandbrushingscreenState();
}

class _desheddingandbrushingscreenState extends State<desheddingandbrushingscreen> {
  String? selectedPet;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Deshedding & Haircutting'),
        leading: IconButton(
